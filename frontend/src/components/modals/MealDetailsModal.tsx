...
import { Clock, ChefHat, Flame, Check, Pencil, RotateCcw, Users } from 'lucide-react';
  ...
  return (
    <Modal open={open} onClose={onClose} title={meal.name} footer={footer}>
      <div className="space-y-5">
        ...
        {/* Portions (ajustables dans les deux contextes) */}
        ...
        {totalSteps > 0 && (
          <div>
            <div className="mb-2 flex items-center justify-between">
              ...
              {isPlanContext && doneCount > 0 && (
                <button onClick={handleReset} className="btn-ghost text-xs text-stone-500">
            ...
            <ol className="space-y-2">
              {steps.map((step) => {
                const isDone = isPlanContext && done.has(step.stepNumber);
                return (
                  <li
                    key={step.stepNumber}
                    className={cn(
                  ...
                  >
                    ...
                    <div className="min-w-0 flex-1">
                      ...
                      <p className={cn('text-sm leading-relaxed text-stone-700', isDone && 'text-stone-400 line-through')}>
                        {step.instruction}
                      </p>
                    </div>
                  </li>
